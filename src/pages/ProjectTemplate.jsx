                    ...
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div className="space-y-24">
                            {gallery.map((img, idx) => (
                                ...
                                >
                                    {/* Image Section - Original Size / Diagram Style */}
                                    <div className="flex-1 w-full flex justify-center">
                                        <div className="relative p-2 rounded-xl border border-white/5 bg-white/[0.02]">
                                            <img
                                                ...
                                                loading="lazy"
                                                style={{ maxHeight: '600px' }} // Limit max height to prevent extremely tall images
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex-1 w-full space-y-6">
                                        <div className="flex items-center gap-4 text-[#D3FD50]/50 font-[font2] text-6xl">
                                            {String(idx + 1).padStart(2, '0')}
                                            <div className="h-px flex-1 bg-gradient-to-r from-[#D3FD50]/20 to-transparent" />
                                        </div>
                                        <div>
                                            <h3 className="font-[font2] text-white text-2xl lg:text-3xl mb-4 leading-tight">
                                                {img.title || img.alt}
                                            </h3>
                                            {img.description && (
                                                <p className="text-white/60 font-[font1] text-lg leading-relaxed border-l-2 border-[#D3FD50]/30 pl-6">
                                                    {img.description}
                                                </p>
                                            )}
                                        </div>
