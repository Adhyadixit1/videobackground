export const translations = {
    fr: {
        ...
        services: {
            ...
            explore: 'Explorer',
            s1Title: 'Diffusion Écrans',
            s1Desc: 'Diffusez vos publicités sur nos écrans digitaux premium dans des lieux stratégiques.',
            s2Title: 'Publicités Digitales',
            s2Desc: 'Élargissez votre portée avec des campagnes réseaux sociaux ciblées qui complètent votre affichage extérieur.',
            s3Title: 'Production Vidéo',
            s3Desc: 'Créez du contenu vidéo impactant optimisé pour l\'affichage digital dans notre studio professionnel.',
            s4Title: 'Installation d\'Écrans',
    ...
    en: {
        ...
        network: {
            ...
            desc1: 'With over 600 gas stations and nearly 4,000 screens in France, you will definitely find a location near your establishment.',
        ...
        services: {
            ...
            explore: 'Explore',
            s1Title: 'Screen Diffusion',
            s1Desc: 'Broadcast your ads on our premium digital screens across strategic locations.',
            s2Title: 'Digital Ads',
            s2Desc: 'Extend your reach with targeted social media campaigns that complement your outdoor advertising.',
            s3Title: 'Video Production',
            s3Desc: 'Create impactful video content optimized for digital signage in our professional studio.',
            s4Title: 'Screen Installation',
    ...
    de: {
        ...
        services: {
            ...
            explore: 'Erkunden',
            s1Title: 'Bildschirmübertragung',
            s1Desc: 'Übertragen Sie Ihre Anzeigen auf unseren Premium-Digitalbildschirmen an strategischen Standorten.',
            s2Title: 'Digitale Anzeigen',
            s2Desc: 'Erweitern Sie Ihre Reichweite mit gezielten Social-Media-Kampagnen, die Ihre Außenwerbung ergänzen.',
            s3Title: 'Videoproduktion',
            s3Desc: 'Erstellen Sie wirkungsvolle Videoinhalte, die für Digital Signage optimiert sind, in unserem professionellen Studio.',
            s4Title: 'Bildschirminstallation',
